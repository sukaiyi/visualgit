...
@Slf4j
public class CalendarChartHandler extends AbstractFreemakerHandler {

    private Chart calendarChart = new CalendarChart();

    @Override
    protected String getTemplate(HttpServerExchange exchange) {
        return "calendarChart.ftl";
    }
    ...
    protected Object getDataModel(HttpServerExchange exchange) {
        ...
        return calendarChart.data(commitInfos);
    }
}
